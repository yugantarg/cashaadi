...
final class Config {
	...
	const FIELD_LINKEDIN      = 602; // textbox, optional, Basic Details after Bio; stored as the canonical profile URL (v1.63.0)
	const FIELD_INSTAGRAM     = 603; // textbox, optional, Basic Details after LinkedIn; stored as the bare username (v1.63.0)
